...
.method maybeRequestFillLocked()V
    ...
    invoke-static {v0}, Lcom/android/server/autofill/Session;->access$400(Lcom/android/server/autofill/Session;)Lcom/android/server/autofill/RemoteFillService;
...
.method public onHandleAssistData(Landroid/os/Bundle;)V
    ...
    .line 475
    invoke-static {v0}, Lcom/android/server/autofill/Session;->access$500(Lcom/android/server/autofill/Session;)Lcom/android/server/autofill/Session$SessionFlags;
    ...
    .line 474
    invoke-static {v0, v5, v6, v4}, Lcom/android/server/autofill/Session;->access$600(Lcom/android/server/autofill/Session;Ljava/lang/Exception;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lcom/android/server/autofill/Session;->access$700(Lcom/android/server/autofill/Session;)Landroid/view/autofill/AutofillId;
    ...
    invoke-static {v9}, Lcom/android/server/autofill/Session;->access$900(Lcom/android/server/autofill/Session;)Z
    ...
    invoke-static {v9}, Lcom/android/server/autofill/Session;->access$1100(Lcom/android/server/autofill/Session;)Lcom/android/server/autofill/AutofillManagerServiceImpl;
    ...
    .line 530
    invoke-static {v10}, Lcom/android/server/autofill/Session;->access$1000(Lcom/android/server/autofill/Session;)Landroid/content/ComponentName;
    ...
    invoke-static {v10, v11}, Lcom/android/server/autofill/Session;->access$1202(Lcom/android/server/autofill/Session;Landroid/app/assist/AssistStructure$ViewNode;)Landroid/app/assist/AssistStructure$ViewNode;

    .line 536
    iget-object v10, v1, Lcom/android/server/autofill/Session$AssistDataReceiverImpl;->this$0:Lcom/android/server/autofill/Session;

    invoke-static {v10}, Lcom/android/server/autofill/Session;->access$1200(Lcom/android/server/autofill/Session;)Landroid/app/assist/AssistStructure$ViewNode;
    ...
    .line 540
    invoke-static {v13}, Lcom/android/server/autofill/Session;->access$1200(Lcom/android/server/autofill/Session;)Landroid/app/assist/AssistStructure$ViewNode;
    ...
    invoke-static {v12}, Lcom/android/server/autofill/Session;->access$1300(Lcom/android/server/autofill/Session;)Landroid/util/ArrayMap;
    ...
    invoke-static {v8}, Lcom/android/server/autofill/Session;->access$1400(Lcom/android/server/autofill/Session;)Ljava/util/ArrayList;
    ...
    invoke-static {v8, v9}, Lcom/android/server/autofill/Session;->access$1402(Lcom/android/server/autofill/Session;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Lcom/android/server/autofill/Session;->access$1400(Lcom/android/server/autofill/Session;)Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Lcom/android/server/autofill/Session;->access$1500(Lcom/android/server/autofill/Session;)V
    ...
    invoke-static {v9}, Lcom/android/server/autofill/Session;->access$1400(Lcom/android/server/autofill/Session;)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10, v13}, Lcom/android/server/autofill/Session;->access$1600(Lcom/android/server/autofill/Session;Landroid/service/autofill/FillContext;I)V
    ...
    .line 564
    invoke-static {v8, v3}, Lcom/android/server/autofill/Session;->access$1700(Lcom/android/server/autofill/Session;Z)Ljava/util/ArrayList;
    ...
    invoke-static {v8}, Lcom/android/server/autofill/Session;->access$1800(Lcom/android/server/autofill/Session;)Landroid/os/Bundle;
    ...
    invoke-static {v0}, Lcom/android/server/autofill/Session;->access$1900(Lcom/android/server/autofill/Session;)Landroid/os/IBinder;
    ...
    invoke-static {v0}, Lcom/android/server/autofill/Session;->access$1100(Lcom/android/server/autofill/Session;)Lcom/android/server/autofill/AutofillManagerServiceImpl;

    move-result-object v0

    iget-object v4, v1, Lcom/android/server/autofill/Session$AssistDataReceiverImpl;->this$0:Lcom/android/server/autofill/Session;

    invoke-static {v4}, Lcom/android/server/autofill/Session;->access$1900(Lcom/android/server/autofill/Session;)Landroid/os/IBinder;
    ...
    .line 513
    invoke-static {v8, v0, v9, v10}, Lcom/android/server/autofill/Session;->access$600(Lcom/android/server/autofill/Session;Ljava/lang/Exception;Ljava/lang/String;[Ljava/lang/Object;)V
